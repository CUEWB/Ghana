...
// ready.js
function scrollToAnchor(){$('a[href^="#"]').each(function(){var e=$(this).attr("href");$(this).click(function(t){t.preventDefault(),$("html,body").animate({scrollTop:$(e).offset().top+1},"slow")})})}function selectOnScroll(){$("#nav-menu li a").each(function(){var e=$(this).attr("href");$(e).waypoint(function(t){"down"===t?($("#nav-menu li.selected").removeClass("selected"),$('#nav-menu li a[href="'+e+'"]').parent().addClass("selected")):"up"===t&&"#home"!==e&&($("#nav-menu li.selected").removeClass("selected"),$('#nav-menu li a[href="'+e+'"]').parent().prev().addClass("selected"))})})}function loadPhotos(){}function setupButtons(){$(".donate-button").click(function(){window.open("https://ssl.charityweb.net/ewbusa/?Custom4=2641","_blank")})}function loadYear(){var e=new Date;$(".year").text(e.getFullYear())}$(document).ready(function(){scrollToAnchor(),selectOnScroll(),loadPhotos(),setupButtons(),loadYear()});